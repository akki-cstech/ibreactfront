                                ...
                                <Grid container>
                                    ...
                                    <Grid item lg={4} md={4} sm={4} xs={4}>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid className={styles.fooItems} item xs={12}>
                                                <h5> <Link to='/static/freeresearch'> Image Research </Link> </h5>
                                            </Grid>
                                    ...
                                    <Grid item lg={4} md={4} sm={4} xs={4}>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid className={styles.fooItems} item xs={12}>
                                                <h5> <Link to='/static/privacypolicy'> Privacy Policy </Link> </h5>
                                            </Grid>
                                    ...
                                    <Grid item lg={4} md={4} sm={4} xs={4}>
                                        ...
                                        <Grid container>
                                            ...
                                            <Grid className={styles.fooItems} item xs={12}>
                                                <h5> <Link to='/static/technical'> Technical </Link> </h5>
                                            </Grid>
