            ...
            <Navbar expand="lg" bg="light" style={{ height: "auto" }}>
                <Row className="justify-content-lg-center">
                    <Col lg={{ span: 1, offset: 1 }} xs={12}>
                        ...
                        {pathname === "/myaccounts/changepassword" && 'Change Password'} 
                        {pathname === '/myaccounts/editUser' && 'Edit Profile'} 
                    ...
                    <Col lg={{ span: 9, offset: 1 }} xs={12}>
                        <Nav className="me-auto pt-3" style={{ color: "black" }}>
                            ...
                            {pList.length > 0 && <Nav.Link onClick={() => history.push('/myaccounts/showAllProposal')} style={{ width: "200px", color: "black" }}>Proposal</Nav.Link>}
