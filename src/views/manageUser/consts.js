export const COUNTRY_OPTIONS_LIST = [
    { id: "", name: "Select your Country" },
    { id: "Afghanistan", name: "Afghanistan" },
    { id: "land Islands", name: "land Islands" },
...
export const JOB_OPTIONS_LIST = [
    { name: "Select Job Description", id: "" },
    { name: "Freelance Designer", id: "Freelance Designer" },
    { name: "Graphic Designer", id: "Graphic Designer" },
    { name: "Art Director", id: "Art Director" },
    { name: "Accounts Payable", id: "Account Executive " },
    { name: "Illustrator", id: "Illustrator" },
    { name: "Art Buyer", id: "Art Buyer" },
    { name: "Photo Editor", id: "Photo Editor" },
    { name: "Creative Director", id: "Creative Director" },
    { name: "Web Designer", id: "Web Designer" },
    { name: "Multi-Media Producer", id: "Multi-Media Producer" },
    { name: "Photographer", id: "Photographer" },
    { name: "Student", id: "Student" },
    { name: "Production Manager", id: "Production Manager" },
    { name: "Marketing Director", id: "Marketing Director" },
    { name: "Corp Communications Director", id: "Corp Communications Director" },
    { name: "Owner/CEO", id: "Owner/CEO" },
    { name: "Public Relations Officer", id: "Public Relations Officer" },
    { name: "Religious Affiliate", id: "Religious Affiliate" },
    { name: "Client Serving", id: "Client Serving" },
    { name: "Other", id: "Other" },
];
...
export const STATE_OPTIONS_LIST = [
    ...
    { id: "Andhra Pradesh (New)", name: "Andhra Pradesh (New)" },
