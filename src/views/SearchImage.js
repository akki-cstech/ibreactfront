...
const SearchImage = ({ onLoader, progress, setProgress }) => {
    ...
    const fetchSearchOnLoad = async () => {
        ...
        console.log("Final Result : ", res.res);
        ...
        if (res.res.data.data) {
            ...
            setLoderRun(false);
            console.log("SearchLeng", SearchRecord.length)
    ...
    window.onscroll = async (e) => {
        ...
        if (offsetHeight - 1500 <= (pageYOffset + pageYOffset)) {
            ...
            if (IsPreviourEnvent === true) {
                ...
                console.log("  SearchRecord Length", SearchRecord.length)
    ...
    return (
        <>
            ...
            {SearchRecord.length === 0 && isActive === false ?
                ...
                : ""}
            {parseInt(SearchRecord.length + 30) >= 3000 ?
                <Footer />
                : ""
            }
            {parseInt(SearchRecord.length) >= parseInt(totalLength) ?
                <Footer />
