                ...
                <Col xs={12} sm={9}>
                    <Row className="justify-content-xs-center">
                        <Col xs={12} className="bg-light mb-4" style={{ fontSize: "28px", position: "relative", top: "8px" }}>
                            <i className="fa fa-lightbulb-o"></i> Mash Editorial Rights License Agreement
                        </Col>
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            <p>THIS IS A LEGAL AGREEMENT (HEREINAFTER REFERRED TO AS THE "AGREEMENT") BETWEEN YOU/ PURCHASER (IF ANY) YOUR COMPANY, AFFILIATES, SUBSIDIARIES, EMPLOYER AND/OR CLIENT (IN CASE YOU ARE AN AGENT ACTING FOR A SINGLE CLIENT), AS THE CASE MAY BE (COLLECTIVELY "LICENSEE")</p>
                            <p>AND M/S MASH AUDIO VISUALS PVT. LTD., WHICH OWNS AND OPERATES THE WEBSITE <a href="https://www.imagesbazaar.com/">WWW.IMAGESBAZAAR.COM</a> (HEREINAFTER REFERRED TO AS "WEBSITE"), A
                                COMPANY INCORPORATED UNDER THE COMPANIES ACT, 1956 AND HAVING ITS REGISTERED OFFICE AT 505, AGGARWAL
                                PRESTIGE MALL ,PLOT NO.2, ROAD NO.44, PITAM PURA, NEW DELHI-110034, HEREINAFTER REFERRED TO AS "MASH"
                                (WHICH EXPRESSION SHALL MEAN AND INCLUDE ITS AFFILIATES, SUBSIDIARIES, ITS SUCCESSORS, NOMINEES,
                                ADMINISTRATORS AND PERMITTED ASSIGNS). </p>
                        ...
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            <h5 style={{ borderBottom: "2px solid", padding: "2px", display: "inline" }}>1. DEFINITIONS</h5>
                            <p className="mt-2"><strong>1.1 "GALLERY DATABASE" </strong> means any digital library or catalogue of images maintained or
                                accessed via MASH through its website <a href="https://www.imagesbazaar.com/">www.imagesbazaar.com</a>
                                which may be divided in any manner. </p>
                            ...
                            <p><strong>1.4 EDITORIAL LICENSED MATERIAL </strong> means Licensed Material used for reporting events that
                                are newsworthy or of public interest that is licensed for use in an editorial manner. </p>
                            <p><strong>1.5 INVOICE </strong>means the computer generated or pre-printed standard form invoice provided
                                by MASH or an authorized distributor setting out the terms agreed with the Licensee. The invoice shall be
                                incorporated into this Agreement and all references to the Agreement shall include the invoice.</p>
                            <p><strong>1.6. LICENSED MATERIAL </strong>means any still image, film or video footage, visual
                                representation, including any negatives, transparencies, film imprints, prints, original digital files, or
                                any other product(s) protected by copyright, trademark, patent or other rights, which is licensed to
                                Licensee by MASH under the terms of this Agreement. Any reference in this Agreement to the Licensed
                                Material shall be to each individual item within the Licensed Material and also to the Licensed Material
                                as a whole.</p>
                            <p><strong>1.7 LICENSEE WORK </strong> means an end product or service that has been created by or on behalf
                                of Licensee using independent skill and effort and that incorporates a Reproduction of the Licensed
                                Material as well as other Material.</p>
                            <p><strong>1.8 REPRODUCTION AND REPRODUCE </strong>means any form of copying, distribution, duplication or
                                publication of the whole or a part of any Licensed Material, via any medium any by whatever means, the
                                distortion, alteration, cropping or manipulation of the whole or any part of the Licensed Material, and
                                the creation of any derivative work from, or that incorporates, the Licensed Material.</p>
                            <p><strong>1.9 RIGHTS AND RESTRICTIONS </strong>means the information available to the Licensee at the time
                                of accessing the Website and selection of the Licensed Material, either: (i) accompanying the Licensed
                                Material on the Website (including all areas of the purchase process); (ii) Terms of Use of the site;
                                (iii) in a written quote issued by MASH; (iv) in the editorial feed; (v) in the invoice, and (vi) in any
                                other written communication accompanying the Licensed Material. Such restrictions may include, without
                                limitation, the permitted scope of use, restrictions for usage, duration of license, any territory or
                                other restrictions applicable to the Licensed Material selected. The Rights and Restrictions shall be
                                incorporated into this Agreement and all references to the Agreement shall include the Rights and
                                Restrictions.</p>
                        </Col>
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            <h5 style={{ borderBottom: "2px solid", padding: "2px", display: "inline" }}>2. GRANT OF RIGHTS AND RESTRICTIONS</h5>
                            <p className="mt-2"><strong>2.1 </strong>MASH grants to Licensee a non-exclusive, non-sub-licensable, temporary, restricted
                                and non-assignable right to use and reproduce the Licensed Material identified in the Invoice, solely to
                                the extent explicitly stated in this Agreement. The rights granted under the Agreement may be exercised by
                                sub-contractors of the Licensee, provided that such subcontractors agree to abide by all the terms and
                                conditions of this Agreement and Terms of Use of the Website. </p>
                            <p><strong>2.2 </strong>Unless additional rights are stipulated in the Rights and Restrictions or granted
                                ...
                                public interest.</p>
                            <p><strong>2.3 </strong>Editorial Licensed Material may be cropped, provided that the editorial integrity of
                            ...
                            <p><strong>2.4 </strong>Use of the Licensed Material is strictly limited to the use, medium, period of time,
                                placement, size of Licensed Material, territory and any other restrictions specified in the Rights and
                                Restrictions. MASH grants a license to reproduce or use the Licensed Material for a period of 10 years
                                only in the territory/country in which the license to use the Licensed Material has been acquired by
                                making the payment. The license will automatically terminate, unless terminated earlier, at the end of the
                                license period. If the Licensee wants to use the Licensed material after a period of 10 years, or want to
                                use the Licensed Material in any other territory/country, the Licensee has to procure a fresh license from
                                MASH and pay the license fee as per the current pricing of the Licensed Material at that time. </p>
                            <p><strong>2.5 </strong>Pornographic, defamatory, libelous, immoral, obscene, fraudulent or otherwise
                                unlawful use of Licensed Material is strictly prohibited, whether directly or in context or in
                            ...
                            <p><strong>2.6 </strong>Licensed Material shall not be incorporated into a logo, trademark or service mark.</p>
                            ...
                            <p><strong>2.8 </strong>Licensed Material may not be modified, reconfigured or repurposed for any use in any
                                mobile-directed websites or mobile applications that are specifically created for viewing of Licensed
                            ...
                            <p><strong>2.10 </strong>Unless otherwise authorized by applicable law or specified in the Rights and
                                Restrictions, Licensee may not, directly or indirectly, reproduce the final product of the Licensed use in
                                any secondary reproductions, such as compilations, in-context promotions or on file-sharing, social
                                networking websites such as YouTube, Facebook, Myspace, etc. or screen shots. Such reproductions require
                                an additional license and prior written permission from MASH and may be subject to payment of additional
                                license fees.</p>
                            <p><strong>2.11 </strong>Licensed Material shall not be used contrary to any restriction on use that is
                                ...
                                Agreement. </p>
                            <p><strong>2.12 </strong> Licensed Material may be cropped but shall not, under any circumstances, otherwise
                                be altered, changed or tampered with, either manually or electronically, without MASH express written
                                permission. </p>
                            <p><strong>2.13 </strong>Upon reasonable notice, MASH may inspect any records, accounts and books relating
                            ...
                            <p><strong>2.14 </strong>Licensee grants to MASH the irrevocable, perpetual, royalty-free, non-exclusive
                            ...
                            <p><strong>2.15 </strong>Licensed Material shall not be used contrary to any restriction on use that is
                                provided to the Licensee prior to or at the time the Licensed Material is delivered to the Licensee. Such
                                restrictions may be included in the Rights and Restrictions or in any other written communication from
                                MASH. Any such restriction provided to the Licensee shall be incorporated into and become part of this
                                Agreement. </p>
                            <p><strong>2.16 </strong>Where Purchaser is licensing Licensed Material on behalf of a Licensee, Purchaser
                                ...
                                Licensee and has full power and authority to bind Licensee to this Agreement; and (ii) if Licensee
                                ...
                                Agreement. Nothing in this Section shall serve to excuse Purchaser's obligation to make payment to MASH
                                for the Licensed Material.</p>
                            <p><strong>2.17 </strong>If the Rights and Restrictions include website use, Licensee shall post terms and
                                ...
                                Licensed Material. </p>
                            <p><strong>2.18 </strong>Any of the body parts or basic features of the model(s) in the Licensed material
                        ...
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            ...
                            <p><strong>3.4 PHOTO CREDIT</strong> Editorial Licensed Material must include the following credit line
                                ...
                                equity. </p>
                            <p><strong>3.5 NOTICE OF VIOLATIONS </strong> Licensee will immediately notify MASH if it becomes aware or
                                suspects that any third party that has gained access to the Licensed Material through Licensee, is
                                wrongfully using the Licensed Material, in whole or in part, or is violating any of MASH's intellectual
                                property rights and other rights, including, but not limited to, MASH Marks and Copyrights.</p>
                        </Col>
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            ...
                            <p><strong>4.3 </strong>If any Licensed Material featuring a model or property is used in connection with a
                                subject that would be unflattering or controversial to a reasonable person or in a manner that would lead
                                a reasonable person to believe that the model personally uses or endorses a product or service, Licensee
                                must accompany each such use with a statement that indicates that: (i) the Licensed Material is being used
                                for illustrative purposes only; and (ii) any person depicted in the Licensed Material, if any, is a model.
                            </p>
                        </Col>
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                        ...
                        <Col xs={12} className="mb-2 mt-2 text-justify">
                            <h5 style={{ borderBottom: "2px solid", padding: "2px", display: "inline" }}>10. ACKNOWLEDGEMENT</h5>
                            <p>
